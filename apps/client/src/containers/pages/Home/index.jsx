        ...
        <div className="mx-auto max-w-5xl bg-gray-600">
          <div className="pt-4 sm:pb-4 sm:pt-9 md:pt-5 mx-auto max-w-5xl px-11 sm:px-14">
            <section className="flex flex-col">
              <h3 className="flex justify-center z-10 sm:justify-start text-center font-ifc-insane-rodeo-bold text-3xl sm:text-[42px] md:text-5xl mb-2 text-intense-orange drop-shadow-[0_6px_4px_rgba(0,0,0,0.4)]">
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between items-center sm:h-11 lg:h-16 mb-3">
                ...
                <span className="flex items-end mb-2 sm:mb-5">
                  <a className="text-chocolate-brown bg-vibrant-yellow px-11 py-4 text-lg font-bold">
                    Consulta aqui
                  </a>
                </span>
              </div>
