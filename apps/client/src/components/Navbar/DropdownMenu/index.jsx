...
export const DropdownMenu = () => {
  ...
  const baseLinkClass = "text-3xl border-b-8 hover:text-intense-orange hover:border-intense-orange text-intense-orange font-bold transition ease"
          ...
          >
              ...
              {links.map(({ to, label }) => (
                <li key={label} className="">
                  <NavLink 
                    to={to} 
                    className={({ isActive }) =>
                      isActive ? linkClass : `${baseLinkClass} text-white border-transparent`
                    }
                  >
                    {label}
                  </NavLink>
            ...
            <ul className="flex flex-col justify-center mt-7 gap-7">
              <li className="w-full bg-fire-red py-3">
                <NavLink className={`text-3xl hover:text-intense-orange font-bold transition ease flex max-w-xs mx-auto w-full text-white`}>
                  Pide aquí
                </NavLink>
              </li>
